...
namespace Dgm.Common.Authorization.MenuControl.Resource
{
    ...
    {
        public static readonly KeyValuePair<string, string> Accounting = new("Accounting", "accounting");
        ...
        public static readonly KeyValuePair<string, string> CustomerPaymentEntry = new("Customer Payment", "customerpayment");
    }
}
